...
function refreshCurrency(){qsa(".money").forEach(x=>x.textContent=money(Number(x.dataset.inr)));qs("#netWorth").textContent=money(1534250);qs("#invested").textContent=money(1245000);qs("#gain").textContent=money(289250)}
